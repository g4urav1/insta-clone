...
export default function ResetPass() {
    ...
    return (
        <div className="min-h-screen bg-bg text-white overflow-x-hidden">
            ...
            {true && <main className="bg-bg relative min-h-[calc(100vh-70px)] border-b border-[#494D53]/60 flex flex-col  md:w-1/2 md:mx-auto items-center">
            ...
            {dropdown && <main onClick={() => { setDropdown(false) }} className="absolute inset-0 bg-bg/10 backdrop-blur-[2px] flex items-center justify-center">

                <div  onClick={(e) => e.stopPropagation()} className="w-full md:w-2/5 bg-surface rounded-lg p-4 space-y-3">
                    <div className="flex justify-between"><div className="text-xl font-semibold">Check your Email or phone</div><X onClick={() => { setDropdown(false) }} /></div>
                    <p>If an account matches the information you entered, you'll receive
            ...
            {false && <main className="bg-bg relative min-h-[calc(100vh-70px)] border-b border-[#494D53]/60 flex flex-col md:w-1/2 md:mx-auto  items-center">
                <div className="p-4 space-y-3">
                    <h1 className="text-2xl font-semibold">Reset yor password</h1>
                    <p >

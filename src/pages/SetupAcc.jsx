        ...
        <main className="bg-bg relative min-h-[calc(100vh-70px)] border-b border-[#494D53]/60 flex flex-col md:w-1/2 md:mx-auto justify-center items-center">
          <div className="p-4 space-y-3">
            ...
            <p>
              ...
              pet or something else. No one will see this unless you choose to
              share it. Why do I need to provide my birthday?
            </p>
            <div className="relative mb-5 w-full">
              <input
                type="date"
        ...
        <main className="bg-bg relative min-h-[calc(100vh-70px)] border-b border-[#494D53]/60 flex flex-col  md:w-1/2 md:mx-auto  justify-center items-center">
          <div className="p-4 space-y-3">
            ...
            <div>
              ...
              <p>
                By tapping I agree, you agree to create an account and to
                Instagram's Terms, Privacy Policy and Cookies Policy.
              </p>
              <p>
                The Privacy Policy describes the ways we can use the information
                we collect when you create a profile. For example, we use this
